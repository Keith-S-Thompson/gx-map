# $Id: gx-gen-mapfile.8.pod,v 1.1 2005-12-23 18:28:13-08 kst Exp $
...
B<gx-gen-mapfile> is normally run from a cron job.  It reads
the F<requests.log> file and generates a new F<grid-mapfile>
from scratch.
